      ...
      <div class="w-full">
        <template v-if="isSummaryPage">
          <div class="flex gap-4 items-center">
            <NuxtLink :to="`/${locale}/my-account?tab=orders`" class="border rounded-md p-2 inline-flex items-center justify-center" title="Back to orders" aria-label="Back to orders">
