    ...
    <Transition name="pop-in" mode="out-in">
      <span v-if="avatar" class="relative avatar">
        ...
        <div class="account-dropdown">
          <NuxtLink :to="`/${locale}/wishlist`" class="hover:bg-gray-100"><Icon name="ion:heart-outline" size="16" /><span>Wishlist</span></NuxtLink>
          <NuxtLink :to="`/${locale}/my-account`" class="hover:bg-gray-100"><Icon name="ion:person-outline" size="16" /><span>My Account</span></NuxtLink>
