...
<template>
  <form class="relative items-center flex-1 -space-x-px shadow-sm" @submit.prevent="setSearchQuery(searchQuery)">
    ...
    <input
      ...
      class="z-0 inline-flex items-center w-full p-2 pl-10 text-sm text-gray-500 border border-gray-300 shadow-inner outline-none bg-gray-50 shadow-gray-200 search-input" />
    <span
      v-if="searchQuery"
