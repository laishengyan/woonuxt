...
export function useHelpers() {
   ...
   */
  const formatDate = (date: string): string => new Date(date).toLocaleDateString('en', { month: 'long', day: 'numeric', year: 'numeric' });
   ...
   */
  const formatPrice = (price: string): string => parseFloat(price).toLocaleString('en', { style: 'currency', currency: 'EUR' });
